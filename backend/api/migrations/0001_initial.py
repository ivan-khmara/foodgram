# Generated by Django 2.2.16 on 2022-06-14 17:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Ingredient', verbose_name='Название')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fans', models.ManyToManyField(related_name='fans', to=settings.AUTH_USER_MODEL, verbose_name='В избранном')),
                ('ingredients', models.ManyToManyField(to='api.IngredientForRecipe', verbose_name='Ингредиенты')),
                ('shoppers', models.ManyToManyField(related_name='shoppers', to=settings.AUTH_USER_MODEL, verbose_name='В списке покупок')),
                ('tags', models.ManyToManyField(to='api.Tag', verbose_name='Тег')),
            ],
            options={
                'verbose_name': 'Рецепт',
